...
export const profile = {
  ...
  bio: [
    ...
    "Away from the screen I like to cook, ski, skateboard, play the occasional game and read the occasional book. I also try to attend as many concerts as possible. And ofcourse hang out with my girlfriend and our cat."
  ],
};
...
export type Mention = {
   ...
   */
  tone: string;
  /** One brand mark, shown on the single tilted hover card. */
