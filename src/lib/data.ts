...
export const profile = {
  ...
  bio: [
    "I'm a fullstack engineer at Compileit in Stockholm, building web and app products people like using. I came into it through informatics and interaction design rather than computer science, which mostly means I don't believe in the handoff — how something ends up feeling gets decided while it's being built, not in the document that described it.",
